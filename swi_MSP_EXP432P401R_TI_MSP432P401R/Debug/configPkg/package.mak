...
.dlls,em4f .dlls: swi.pem4f

-include package/cfg/swi_pem4f.mak
-include package/cfg/swi_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/swi_pem4f.dep
endif
swi.pem4f: package/cfg/swi_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
swi.pem4f package/cfg/swi_pem4f.c: .libraries,em4f
endif

package/cfg/swi_pem4f.c package/cfg/swi_pem4f.h package/cfg/swi_pem4f.xdl: override _PROG_NAME := swi.xem4f
package/cfg/swi_pem4f.c: package/cfg/swi_pem4f.cfg
package/cfg/swi_pem4f.xdc.inc: package/cfg/swi_pem4f.xdl
package/cfg/swi_pem4f.xdl package/cfg/swi_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/swi_pem4f.cfg
	-$(RM) package/cfg/swi_pem4f.dep
	-$(RM) package/cfg/swi_pem4f.c
	-$(RM) package/cfg/swi_pem4f.xdc.inc

clean,em4f::
	-$(RM) swi.pem4f
.executables,em4f .executables: swi.xem4f

swi.xem4f: |swi.pem4f

-include package/cfg/swi.xem4f.mak
swi.xem4f: package/cfg/swi_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/swi_pem4f.oem4f   package/cfg/swi_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
swi.xem4f: export C_DIR=
swi.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
swi.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

swi.test test,em4f test: swi.xem4f.test

swi.xem4f.test:: swi.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 swi.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.swi.xem4f, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
swi_pem4f.oem4f,copy : package/cfg/swi_pem4f.oem4f
swi_pem4f.sem4f,copy : package/cfg/swi_pem4f.sem4f
